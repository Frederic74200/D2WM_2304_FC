...
class Match {
    ...
    constructor(_json) {
        ...
        this.gagnant1 = "";
        this.gagnant2 = "";
        this.team1PntMatch1 = 1;
        this.team2PntMatch1 = 1;
        this.team1PntMatch2 = 1;
        this.team2PntMatch2 = 1;
    ...
    trouverGagantsMatchs(equipe1, equipe2, scoreMatch1, scoreMatch2) {
        ...
        score1[0] == score1[1] ? this.gagnant1 = "égalité" : score1[0] > score1[1] ? this.gagnant1 = equipe1 : this.gagnant1 = equipe2;;
        score2[0] == score2[1] ? this.gagnant2 = "égalité" : score2[0] > score2[1] ? this.gagnant2 = equipe1 : this.gagnant2 = equipe2;;

        score1[0] === score1[1] ? this.team1PntMatch1 = this.team2PntMatch1 = 1 : score1[0] > score1[1] ? this.team1PntMatch1 = 3 : this.team2PntMatch1 = 0;
        score2[0] === score2[1] ? this.team1PntMatch2 = this.team2PntMatch2 = 1 : score2[0] > score2[1] ? this.team1PntMatch2 = 3 : this.team2PntMatch2 = 0;;
